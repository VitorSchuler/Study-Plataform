      ...
      <div className={styles.cardWrapper}>
        ...
        <div className={styles.left}>
          ...
          <div className={styles.brand}>
            <span className={styles.logoText}>fokus<span className={styles.dot}>.</span></span>
          </div>

          <div className={styles.leftContent}>
            <h2 className={styles.leftTitle}>Estudo inteligente. <br/> Foco absoluto.</h2>
            <p className={styles.leftSub}>
              Sua plataforma central para organizar matérias, resumos e potencializar seu aprendizado com IA.
            </p>
          </div>
        ...
        <div className={styles.right}>
          <div className={styles.formHeader}>
            <h2 className={styles.formTitle}>
              {tab === 'entrar' ? 'Acesse sua conta' : 'Crie sua conta'}
            </h2>
            <p className={styles.formSub}>
              {tab === 'entrar'
                ? 'Insira seus dados para continuar estudando.'
                : 'O primeiro passo para organizar sua rotina.'}
            </p>
          </div>
